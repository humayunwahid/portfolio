...
import ProfileImg from "../assets/images/portfolio-image-mini.jpg";
...
import clientImg5 from "../assets/images/clients-img5.jpg";
import clientImg6 from "../assets/images/clients-img6.jpg";
import clientImg7 from "../assets/images/clients-img7.jpg";
import clientImg8 from "../assets/images/clients-img8.jpg";
import JessicaMainImg from "../assets/images/portfolio-image.jpg";
...
const Home = () => {
  //Text
  const firstTexts = ["Developer", "Designer"];
  const secondTexts = [
    ...
    <>
      ...
      <div className="main-containe" data-bs-spy="scroll">
        ...
        <section className="section-one overflow-hidden" id="home">
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              ...
              I greatly appreciate your trust. Companies choose my web development services because they know I provide high-quality, innovative solutions every time.
              </p>
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              <div className="worked-box">
                <p className="worked-more">Worked with more than 7 Companies</p>
                <div className="client-img-main position-relative">
                  ...
                  />
                  <img
                    className="client-img client-img5"
                    src={clientImg5}
                    alt="clients-img4"
                  />
                  <img
                    className="client-img client-img6"
                    src={clientImg6}
                    alt="clients-img4"
                  />
                  <img
                    className="client-img client-img7"
                    src={clientImg8}
                    alt="clients-img4"
                  />
                  <img
                    className="client-img client-img8"
                    src={clientImg4}
                    alt="clients-img4"
                  />
        ...
        {/* <section className="Marquee-main overflow-hidden">
          <h3 className="fade_up">Trusted by World Leading Companies</h3>
